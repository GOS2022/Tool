...
namespace GOSTool
{
    ...
    public enum SysmonMessageId
    {
        ...
        SVL_DHS_SYSMON_MSG_DRIVER_DIAG_REQ = 0x5003,
        SVL_DHS_SYSMON_MSG_DRIVER_DIAG_RESP = 0x5A03,
    ...
    public enum SysmonMessagePv
    {
        ...
        SVL_DHS_SYSMON_MSG_DRIVER_DIAG_REQ_PV = 1,
        SVL_DHS_SYSMON_MSG_DRIVER_DIAG_RESP_PV = 1,
